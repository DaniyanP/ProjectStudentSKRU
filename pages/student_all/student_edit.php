...
?>
    ...
    <?php foreach($result2 as $results2){
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="student_project">รหัสโครงงาน</label>
                                <input class="form-control" id="student_project" name="student_project" type="text"
                                    placeholder="กรอกรหัสโครงงาน" required value="<?php echo $student_project?>">
                            </div>
                        </div>
